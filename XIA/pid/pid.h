...
// Sat May  6 14:42:39 2023 by ROOT version 6.24/02
// from TTree tree/GDDAQ Multi-Crate sort Data
// found on file: ../../../data/XIA/rootfile/data_all.root
//////////////////////////////////////////////////////////
...
#ifdef pid_cxx
pid::pid(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../../data/XIA/rootfile/data_all.root");
      // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../../data/XIA/rootfile/data_C1_0003_wave.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../../data/XIA/rootfile/data_all.root");
         // f = new TFile("../../../data/XIA/rootfile/data_C1_0003_wave.root");
      }
...
Int_t pid::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t pid::LoadTree(Long64_t entry)
{
